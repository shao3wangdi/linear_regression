...
[X, Y] = data_generate_real_linear(s, p, f_0, sigma, theta);


[relerror1, theta_now1] =  dp_iht_linear(X, Y, theta, s, eta, max_iter, sigma, epsilon, iter);

new_image1= U*diag(theta_now1.'*a)*V.' ;

epsilon = 2;
[relerror2, theta_now2] =  dp_iht_linear(X, Y, theta, s, eta, max_iter, sigma, epsilon, iter);
...
[relerror4, theta_now4] =  dp_iht_linear(X, Y, theta, s, eta, max_iter, sigma, epsilon, iter);
